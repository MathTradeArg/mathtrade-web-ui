...
const listIcons: Record<string, JSX.Element> = {
  ...
  offer: (
    <>
      <path
        fill="currentColor"
        d="M3 10v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-9h-2v8H5v-8H3z"
      />
      <path
        fill="currentColor"
        d="M11 3h2v7.59l2.29-2.3l1.42 1.42L12 14.42l-4.71-4.71l1.42-1.42L11 10.59V3z"
      />
    </>
  ),
  publisher: (
  ...
  stats: (
    <path
      fill="currentColor"
      d="M4 20h2v-6H4v6zm5 0h2V10H9v10zm5 0h2V4h-2v16zm5 0h2v-9h-2v9z"
    />
  ),
  xls: (
    <g
  ...
  more: (
    <path
      fill="currentColor"
      d="M6 10c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2m12 0c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2m-6 0c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2z"
    />
  ),
  money: (
    <path
